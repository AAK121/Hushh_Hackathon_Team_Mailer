...
def generate_user_key(user_id: str) -> str:
    """Convenience function to generate a new user encryption key"""
    return user_key_manager.get_user_key(user_id)  # get_user_key generates if not exists

def get_user_key(user_id: str) -> str:
    """Convenience function to get a user's encryption key (alias for get_user_encryption_key)"""
