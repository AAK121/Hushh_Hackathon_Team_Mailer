...
def create_no_context_test_file():
    ...
    print("📊 Creating No-Context Test File")
    print("=" * 35)
    ...
    print(f"⚠️  NO description column - testing standard emails")
...
def create_no_context_test():
    ...
    print(f"\n🚀 Creating No-Context Comparison Test")
    print("=" * 45)
...
if __name__ == "__main__":
    print("🚀 No-Context Test File Creator")
    print("=" * 35)
    
    excel_path, test_script_path = create_no_context_test()
    
    print(f"\n🎉 No-Context Test Files Created!")
    print(f"📊 Excel file: {excel_path}")
    print(f"🐍 Test script: {test_script_path}")
    
    print(f"\n📋 Test Comparison:")
    print(f"  🎯 CONTEXT TEST: Rich descriptions → Personalized content")
    print(f"  ⚪ NO-CONTEXT TEST: No descriptions → Standard content")
    
    print(f"\n📧 Same Email Addresses:")
    print(f"  🎮 dragnoid121@gmail.com")
    print(f"  💼 alokkale121@gmail.com") 
    print(f"  🎓 23b4215@iitb.ac.in")
    ...
    print(f"\n✅ Ready for no-context comparison testing!")
