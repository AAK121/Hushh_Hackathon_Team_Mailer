#!/usr/bin/env python3
"""
Create a test Excel file with multiple emails and different contexts
"""

import pandas as pd
from pathlib import Path

def create_multi_email_test_file():
    """Create an Excel file with multiple emails and diverse contexts."""
    
    print("📊 Creating Multi-Email Test File")
    print("=" * 40)
    
    # Test data with different contexts for each recipient
    test_data = [
        {
            'name': 'Dragon',
            'email': 'dragnoid121@gmail.com',
            'company_name': 'GameDev Studios',
            'description': 'Gaming enthusiast and developer, loves technical deep-dives and cutting-edge features. Prefers detailed explanations with examples and code snippets.'
        },
        {
            'name': 'Alok',
            'email': 'alokkale121@gmail.com', 
            'company_name': 'Tech Solutions',
            'description': 'Experienced software engineer, appreciates well-documented solutions and technical accuracy. Values efficiency and professional communication.'
        },
        {
            'name': 'Student',
            'email': '23b4215@iitb.ac.in',
            'company_name': 'IIT Bombay',
            'description': 'Computer science student at IIT Bombay, eager to learn new technologies. Prefers educational content with learning resources and beginner-friendly explanations.'
        }
    ]
    ...
    excel_path = Path("hushh_mcp/agents/mailerpanda/multi_email_test.xlsx")
    ...
    for i, row in df.iterrows():
        ...
        print(f"   Context: {row['description'][:80]}...")
    
    return excel_path

def create_comprehensive_test():
    """Create a comprehensive test with the new Excel file."""
    
    print(f"\n🚀 Creating Comprehensive Multi-Email Test")
    print("=" * 50)
    
    # Create the Excel file first
    excel_path = create_multi_email_test_file()
...
"""
    ...
    test_script_path = Path("test_multi_email_personalization.py")
...
if __name__ == "__main__":
    print("🚀 Multi-Email Test File Creator")
    print("=" * 40)
    
    excel_path, test_script_path = create_comprehensive_test()
    
    print(f"\n🎉 Multi-Email Test Files Created!")
    print(f"📊 Excel file: {excel_path}")
    print(f"🐍 Test script: {test_script_path}")
    
    print(f"\n📋 Test Data Summary:")
    print(f"  🎮 dragnoid121@gmail.com - Gaming developer context")
    print(f"  💼 alokkale121@gmail.com - Professional engineer context") 
    print(f"  🎓 23b4215@iitb.ac.in - Computer science student context")
    
    print(f"\n🚀 Next Steps:")
    print(f"  1. Run: python test_multi_email_personalization.py")
    print(f"  2. Observe personalized content for each recipient type")
    print(f"  3. Check that emails are customized based on context")
    
    print(f"\n✅ Ready for multi-email personalization testing!")
